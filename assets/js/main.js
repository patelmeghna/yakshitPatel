...
(function ($) {
  ...
  if (document.querySelector(".animation__hero_one")) {
    ...
    let split_char_btn = new SplitText(".animation__hero_one a", {
      type: "chars, words",
    });
    // heroOnetl.from(split_char_btn.chars, {duration: 1, x: 70, autoAlpha: 0, stagger: 0.1},'-=1.5');
    heroOnetl.from(split_char_btn.words, {
      duration: 1,
      x: -50,
      opacity: 0,
      autoAlpha: 0,
    ...
    //hero__title
    let split_char_hero = new SplitText(".hero__title", {
      type: "chars, words",
    });
    heroOnetl.from(
      split_char_hero.chars,
      { duration: 1, x: 70, opacity: 0, autoAlpha: 0, stagger: 0.1 },
      "-=1"
    );

    //hero__Sub_title
    let split_char_hero_subtitle = new SplitText(
      ".animation__hero_one .hero__sub-title",
      { type: "words" }
    );
    heroOnetl.from(
      split_char_hero_subtitle.words,
      { duration: 1, x: 50, opacity: 0, autoAlpha: 0, stagger: 0.07 },
      "-=1.5"
    );
    ...
    heroOnetl.to(
      ".animation__hero_one .experience",
      {
        y: 0,
        opacity: 1,
        duration: 2,
  ...
  homeDigi.from(split_title_left.chars, {
    duration: 1,
    x: 70,
    autoAlpha: 0,
    stagger: 0.15,
  ...
  homeDigi.from(
    split_title_right.chars,
    { duration: 1, x: 70, autoAlpha: 0, stagger: 0.15 },
    "-=.65"
  );
